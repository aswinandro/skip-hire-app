...
const SkipList = ({ skips, selectedSkip, handleSelectSkip }) => {
  ...
  return (
    <div className="w-full lg:w-1/3">
      <div className="bg-gray-900 rounded-xl p-2 lg:p-4 border border-gray-700 shadow-2xl h-full max-h-[80vh] flex flex-col">
        {/* Heading with Arrows (mobile only) */}
        <div className="flex justify-between items-center mb-2 lg:mb-4">
          <h3 className="text-xl lg:text-2xl font-bold text-silver border-b border-gray-700 w-full">
